...
$(document).ready(function () {
    ...
    if (obj) {
        ...
        if (obj.Beneficiarios) {
            listaBeneficiarios = obj.Beneficiarios;
    ...
    $("#btnIncluirBeneficiario").click(function () {
        ...
        var idTemp = Math.floor(Math.random() * 1000000);
...
function RenderizarGridBeneficiarios() {
    ...
    $.each(listaBeneficiarios, function (index, benef) {
        ...
        var btnAlterar = $("<button type='button'>").addClass("btn btn-primary btn-sm").text("Alterar").css("margin-right", "5px").click(function() {
            PrepararAlteracaoBeneficiario(benef.IdTemp || benef.Id);
        });
        var btnExcluir = $("<button type='button'>").addClass("btn btn-primary btn-sm").text("Excluir").click(function() {
